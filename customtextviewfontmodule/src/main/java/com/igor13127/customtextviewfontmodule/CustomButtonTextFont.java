...
public class CustomButtonTextFont extends Button {
    ...
    public CustomButtonTextFont(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomButtonTextFont(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
